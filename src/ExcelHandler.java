...
public final class ExcelHandler {
	...
	private static String[] extractInfoFromCell(List<Cell> cells) {
        ...
        cellValues[5] = getCellValue(cells.get(5));

        cellValues[6] = getCellValue(cells.get(6));

        cellValues[7] = getCellValue(cells.get(7));

        cellValues[8] = getCellValue(cells.get(8));

        cellValues[9] = getCellValue(cells.get(9));

        cellValues[10] = getCellValue(cells.get(10));

        cellValues[11] = getCellValue(cells.get(11));

        cellValues[12] = getCellValue(cells.get(12));

        cellValues[13] = getCellValue(cells.get(13));

        cellValues[14] = getCellValue(cells.get(14));
